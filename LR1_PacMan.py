...
pygame.display.set_caption("Pac-Man Panasiuk Kyryl TK-41_lab-1")
...
class GameTimer:
    def __init__(self):
        ...
        self.phase_durations = {
            'chase': 24 * 60,      # 24 секунд переслідування
            'scatter': 8 * 60      # 8 секунд розсіювання
        }
...
current_level = 1
max_levels = 10  # Кількість рівнів з наростанням складності
